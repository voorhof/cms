<x-cms-layout>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form method="POST" action="{{ route(config('cms.route_name_prefix').'.posts.store') }}" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <x-cms.input-text type="text" id="title" name="title"
                                          :value="old('title')" :isInvalid="$errors->has('title')"
                                          required />
                        ...
                        <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between py-1">
                            ...
                            <a href="{{ route(config('cms.route_name_prefix').'.posts.index') }}" class="btn btn-dark">
